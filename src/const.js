...
const KEYWORDS_TO_REMOVE = [
  "Дордой", "дордой", "Дорд", "дорд", "прох", "проход", "Прох", "Проход",
  "конт", "кон", "Конт", "Кон", "ряд", "р.", "-1", "-2", "-3", "-4", "-5",
  "АЗС", "азс", "Азс", "север", "Арктика", "Гермес", "/", "\\", "|", "пр",
  "к.", "китайский", "кит", "ЛЭП", "лэп", "Кишка", "кишка", "Алкан", 
  "Меркурий", "Брючный", "адрес", "Адрес", "адр.", "Адр.", "од", 'ад'
];
